...
import magicMouseSliderImg1 from "../../../assets/images/magicMouseSliderImg1.jpg";
import magicMouseSliderImg2 from "../../../assets/images/magicMouseSliderImg2.jpg";
import magicMouseSliderImg3 from "../../../assets/images/magicMouseSliderImg3.jpg";
import icon3D from "../../../assets/images/3dIcon.png";


const MagicMouseFeaturesAndGallery = () => {
  const images = [
    magicMouseSliderImg1,
    magicMouseSliderImg2,
    magicMouseSliderImg3,
  ...
  return (
    ...
    >
      ...
      <div className="md:w-1/2 p-4">
        <h2 className="text-2xl sm:text-3xl font-bold mb-4">Apple Magic Mouse Features</h2>
        <ul className="list-disc pl-5 space-y-2 text-gray-700">
          <li>Multi-touch surface lets you swipe, scroll, and navigate effortlessly</li>
          <li>Wireless and rechargeable with long-lasting internal battery</li>
          <li>Seamlessly pairs with Mac for smooth and responsive performance</li>
          <li>Sleek, low-profile design for maximum portability and style</li>
          <li>Optimized for macOS with built-in gesture support</li>
        </ul>
      </div>
...
export default MagicMouseFeaturesAndGallery;
