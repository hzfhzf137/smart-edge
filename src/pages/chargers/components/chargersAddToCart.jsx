...
const ChargersAddToCart = ({ productId: _id, name, description, price }) => {
    ...
    <section className="max-w-7xl mx-auto p-4" data-aos="fade-up" data-aos-duration="1000">
      ...
      {showPopup && (
        <div
          ...
          className="fixed top-0 left-0 w-full pt-5 pb-5 rounded-2xl z-50 flex items-center justify-center bg-black/30 backdrop-blur-[2px]"
        >
          <div
